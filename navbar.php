...
<html lang="en" >
    <head>
        <meta charset="UTF-8">
        <?php
        if ($_GET && isset($_GET['i']) && strcmp($_GET['i'], "i") == 0) {
            echo '
    ...
    <body>
        <script>
            function esq() {
                ...
                var f = "esqueciMinhaSenha.php?page=<?= $_SERVER['REQUEST_URI']; ?>";
        ...
        <div id="modalLogin" class="modal fade" role="dialog">
            <div class="modal-dialog">
                ...
                <!-- Conteúdo do modal-->
                <div class="modal-content">
                    <form class="form-horizontal" id="formlogin" action="login.php?page=<?= $_SERVER['REQUEST_URI']; ?>" method="post">
                        <!-- Cabeçalho do modal -->
                        <div class="modal-header">
                        ...
                        <div style="background-color: #EBECF0" class="modal-body">
                            ...
                            <input type="text" class="form-control input-lg" placeholder="Digite sua senha" id="senhaUser" name="senhaUser" required="" value="ooooo"><br>

                            <button style="margin: 1px 155px;" onclick="esq()" id="esquecid" type="button"> Esqueci minha senha </button>
