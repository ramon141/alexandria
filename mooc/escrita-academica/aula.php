                    ...
                    <figure id="video_playlist" >
                        <div class="row">
                            <div class="col-xl-3 col-lg-3" style="padding: 60px 50px;">
                                <ul>
                                    <li><button onclick="window.location.href='aula.php?modulo=1'" id ="modulo1" class="boxed_btn" style=" color: black; border-radius: 0px; padding: 10px 25px; <?php if($modulo == 1) {echo 'color: white';}?>"> Módulo 1</button></li>
                                    <li><button onclick="window.location.href='aula.php?modulo=2'" class="boxed_btn" style="color: black; border-radius: 0px; padding: 10px 25px;<?php if($modulo == 2) {echo 'color: white';}?>"> Módulo 2</button></li>
                                    <li><button onclick="bloqueado();" class="boxed_btn" style="color: black; border-radius: 0px; padding: 10px 25px;<?php if($modulo == 3) {echo 'color: wincache_ucache_delete(key)';}?>"> Módulo 3</button></li>
                                    <li><button onclick="bloqueado();" class="boxed_btn" style="color: black; border-radius: 0px; padding: 10px 25px;<?php if($modulo == 4) {echo 'color: white';}?>"> Módulo 4</button></li>
                                </ul>
                            </div>
                            <div class="col-xl-7 col-lg-7">
                                <figcaption>
